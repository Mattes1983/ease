...
*******************************************************************/
        ...
        public function __construct()
	{
	    parent::__construct();
            ...
            // JS
            $this->arrConf['js']['extension-popup'] = "basic/generate/js/extension-popup.js";
            
            // CSS
            $this->arrConf['css']['extension-popup'] = "basic/generate/css/extension-popup.css";
        }
	...
	{
	    // Reset generate
	    _Generate::fctPrepareGenerate( array( $_SESSION['easevars']['document'] ) );
